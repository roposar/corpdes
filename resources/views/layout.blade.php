...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="images/Corpdes.ico">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="images/Corpdes.jpg" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="service">Servicios</a></li>
                        <li class="scroll"><a href="portfolio">Portafolio</a></li>
                        <li class="scroll"><a href="about">Acerca De</a></li>
